...
- Confirm you have the curl command-line tool, or install it from the curl website: ```bash curl --version ```
...
![Shows the Simulated Surface Vessel's detail page in the Lattice Developer Console.](/img/anduril.docs.buildwithfern.com/f4a1cc6ad39c631b2b40aba648adf11805f4168f9e5be4005d1ec8ffe8aa5a55/assets/images/screenshots/developer-console-surface-vessel-detail.png)

## What’s next?

- Explore the different Lattice entity shapes .
- Learn how to task an asset in Lattice
