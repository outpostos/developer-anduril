...
按 ID 获取特定任务，并可选择特定任务版本或视图。此方法返回任务的详细信息，包括当前状态、specification、relations 和其他元数据。响应包含完整任务对象及所有关联字段。默认情况下，该方法从 manager 视角返回任务的最新定义版本。
...
- `taskId` — _string · required_ — 要返回的任务 ID
