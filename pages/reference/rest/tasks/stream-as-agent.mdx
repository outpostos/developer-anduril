...
- `agentSelector` — _object · optional_ — The selector criteria to determine which tasks the agent receives.
...
- `agent_request` — _object_ — The wrapper for a task’s action requests: execute, cancel, or complete.
